...
export default function Home() {
  ...
  const { extractText, loading, error, text: pdfText, reset: resetPdf } = usePdfTextExtractor();
  const { generateQuiz, quiz, loading: quizLoading, error: quizError, reset: resetQuiz } = useQuizGenerator();
